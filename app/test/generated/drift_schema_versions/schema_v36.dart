...
class Books extends Table with TableInfo {
  ...
  late final GeneratedColumn<int> readerNotesUpdatedAt = GeneratedColumn<int>(
  ...
  late final GeneratedColumn<int> readerNotesNeedsPush = GeneratedColumn<int>(
    ...
    requiredDuringInsert: false,
    $customConstraints:
        'NOT NULL DEFAULT 0 CHECK (reader_notes_needs_push IN (0, 1))',
  ...
  late final GeneratedColumn<int> statusNeedsPush = GeneratedColumn<int>(
    'status_needs_push',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints:
        'NOT NULL DEFAULT 0 CHECK (status_needs_push IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  ...
  late final GeneratedColumn<int> syncExcluded = GeneratedColumn<int>(
    'sync_excluded',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 0 CHECK (sync_excluded IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
...
class FilePositions extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  FilePositions(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> fileId = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: true,
    $customConstraints: 'NOT NULL REFERENCES book_files(id)',
  );
  late final GeneratedColumn<String> bookId = GeneratedColumn<String>(
    'book_id',
    aliasedName,
  ...
  @override
  FilePositions createAlias(String alias) {
    return FilePositions(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const ['PRIMARY KEY(file_id)'];
  @override
  bool get dontWriteConstraints => true;
}
...
class Shelves extends Table with TableInfo {
  ...
  late final GeneratedColumn<int> isPersonal = GeneratedColumn<int>(
    'is_personal',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 0 CHECK (is_personal IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  ...
  late final GeneratedColumn<int> accepted = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NULL CHECK (accepted IN (0, 1))',
  );
  late final GeneratedColumn<int> needsPush = GeneratedColumn<int>(
    'needs_push',
    aliasedName,
...
class PhysicalEnvironments extends Table with TableInfo {
  ...
  late final GeneratedColumn<int> roomSurfaces = GeneratedColumn<int>(
    'room_surfaces',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 1 CHECK (room_surfaces IN (0, 1))',
    defaultValue: const CustomExpression('1'),
  );
...
class PhysicalShelves extends Table with TableInfo {
  ...
  late final GeneratedColumn<String> kind = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT \'shelf\'',
    defaultValue: const CustomExpression('\'shelf\''),
  );
  ...
  late final GeneratedColumn<int> anchored = GeneratedColumn<int>(
    'anchored',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 1 CHECK (anchored IN (0, 1))',
    defaultValue: const CustomExpression('1'),
  );
  late final GeneratedColumn<int> createdAt = GeneratedColumn<int>(
    'created_at',
...
class RoomProps extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  RoomProps(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<int> inFront = GeneratedColumn<int>(
    'in_front',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 0 CHECK (in_front IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  late final GeneratedColumn<int> createdAt = GeneratedColumn<int>(
    'created_at',
  ...
  @override
  RoomProps createAlias(String alias) {
    return RoomProps(attachedDatabase, alias);
  }
...
class BookText extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  BookText(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> fileId = GeneratedColumn<String>(
    'file_id',
    aliasedName,
    false,
  ...
  @override
  BookText createAlias(String alias) {
    return BookText(attachedDatabase, alias);
  }
...
class DatabaseAtV36 extends GeneratedDatabase {
  ...
  late final FilePositions filePositions = FilePositions(this);
  ...
  late final RoomProps roomProps = RoomProps(this);
  ...
  late final BookText bookText = BookText(this);
  @override
