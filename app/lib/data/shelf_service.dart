...
/// Custom shelves (app-local collections; not synced) — manual panes,
/// distinct from genres and from the physical-layout "shelves". They order
/// books explicitly and never delete the books they hold. Split out of
